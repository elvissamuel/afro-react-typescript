...
import CategoryDropdown2 from 'src/components/CtargoryDropDown2';
        ...
        <div className='max-w-[680px] mx-auto my-2 shadow-lg px-10 py-5'>
            ...
            <form onSubmit={(e)=>handleSubmit(e)} className='mt-8 flex flex-col gap-3'>
                ...
                <div className='mt-4 w-[80%] mx-auto'>
                    <button disabled={loading} type='submit' className='bg-primaryColor py-1.5 text-gray-100 rounded-lg w-full'>{loading ? "Loading..." : "Upload Product"}</button>
